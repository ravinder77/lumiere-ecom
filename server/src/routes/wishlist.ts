...
router.get('/', async (req: AuthRequest, res: Response) => {
  ...
  // Enrich with product data from in-memory store
  const enriched = items.map((item: { id: string; userId: string; productId: string; createdAt: Date }) => {
...
// GET /api/wishlist/ids — lightweight: just productIds for the current user
